...
export default function Menu() {
  ...
  async function handleDeleteCookie(cookieId: string) {
    if (!confirm("Êtes-vous sûr de vouloir supprimer ce type de cookie ?")) return;
    try {
    ...
    <div>
      ...
      {isAddingNew && (
        <div className="bg-white/5 border border-white/10 rounded-2xl p-6 mb-6">
          <h2 className="text-lg font-semibold text-white mb-4">Ajouter un Nouveau Type de Cookie</h2>
